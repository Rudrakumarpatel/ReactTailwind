...
function Recommendations({ progress, setprogress }) {
  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-center w-full h-full mt-9 items-center mb-9">
        <header className="flex-col justify-center items-center mt-10">
          ...
          mt-5 lg:mt-7">choose one to get started.You can switch anytime</p>
        </header>
        <div className="grid grid-row-2 gap-5 justify-center items-center h-full w-full lg:flex lg:flex-row mt-9 lg:justify-center lg:items-center">
          <div className="relative flex flex-col xl:w-96 justify-center items-center w-full">
            <p className="absolute -top-3 left-7 bg-yellow-300 z-10 text-black rounded-lg p-1 text-xs lg:text-base">
              Most Popular
            </p>
            <button className="w-full h-40 rounded flex border justify-between xl:w-96 items-center">
              <p className={`mt-3 p-2 text-center flex flex-col flex-wrap ml-3 xl:w-52 lg:text-base text-sm `}>
              ...
              <img
                ...
                : ""}
                alt="history_image"
                className="sm:w-32 sm:h-full sm:rounded-xl rounded-xl w-24 h-32
          ...
          <div className="relative flex flex-col xl:w-96 justify-center items-center w-full">
            <button className="w-full h-40 rounded flex border justify-between xl:w-96 items-center">
              <p className="mt-3 p-2 text-center flex flex-col flex-wrap ml-3 xl:w-52 text-sm lg:text-base">
